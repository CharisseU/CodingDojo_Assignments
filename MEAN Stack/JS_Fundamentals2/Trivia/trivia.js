...
function getTriviaData(){
    ...
    {
        resolve($.get("https://opentdb.com/api.php?amount=10&category=9&type=multiple"));
    });
    ...
    {
        resolve($.get("https://opentdb.com/api.php?amount=10&category=10&difficulty=medium&type=multiple"));
    });
    ...
    {
        resolve($.get("https://opentdb.com/api.php?amount=10&category=27&difficulty=medium&type=multiple"));
    });
    ...
    {
        resolve($.get("https://opentdb.com/api.php?amount=10&category=13"));
    });
